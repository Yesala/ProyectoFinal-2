...
CREATE TABLE `CancionesLista` (
  ...
  `nombreLista` varchar(15) DEFAULT NULL,
  `nombreCancion` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `cancioneslista_idx` (`nombreLista`),
  KEY `cancioneslista_ibfk_2_idx` (`nombreCancion`),
  CONSTRAINT `cancioneslista_ibfk_1` FOREIGN KEY (`nombreLista`) REFERENCES `TLista` (`nombreLista`),
  CONSTRAINT `cancioneslista_ibfk_2` FOREIGN KEY (`nombreCancion`) REFERENCES `TCancion` (`nombreCancion`)
